...
let malos = document.getElementsByName("imagen");
//array con las naves
...
function mover() {
  ...
  for (m of malos) {
    m.style.left = String(x) + "px";
    m.style.top = String(y) + "px";
    /*
    m.style.left = m.offsetleft+velx) + "px";
    m.style.left = m.offsettop2+velx) + "px";
    */
  }
